	...
	Public Class CustomSaveDocumentCommand
		...
		Protected Overrides Sub ExecuteCore()
			If Control.Document.Paragraphs.Count > 7 Then
				MyBase.ExecuteCore()
			Else
				MessageBox.Show("You should type at least 7 paragraphs" & ControlChars.CrLf & "  to be able to save the document.", "Please be creative", MessageBoxButtons.OK, MessageBoxIcon.Information)
			End If
		End Sub
	End Class
